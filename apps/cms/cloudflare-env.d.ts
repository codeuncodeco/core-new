/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 3d3975fb31637a748ac7df3ffb4dd765)
...
declare namespace Cloudflare {
	interface Env {
		...
		D1: D1Database;
		ASSETS: Fetcher;
		WEB_URL: "https://beta.codeuncode.com";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_URL">> {}
}
