/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env local --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2c62ae89f9dac096cd38a5c179afe914)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CMS_URL" | "PAYLOAD_SECRET" | "SEED_SECRET" | "WEB_URL" | "RESEND_API_KEY" | "WEB_DEPLOY_HOOK_URL">> {}
}
