...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(sql`CREATE INDEX \`partners_image_idx\` ON \`partners\` (\`image_id\`);`)
  await db.run(sql`CREATE INDEX \`partners_display_order_idx\` ON \`partners\` (\`display_order\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_partners_v_version_version_image_idx\` ON \`_partners_v\` (\`version_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_partners_v_version_version_display_order_idx\` ON \`_partners_v\` (\`version_display_order\`);`)
